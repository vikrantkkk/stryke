      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 w-full px-60">
        {featuresData.map((feature, index) => (
          <AnimateFromInside>
            <div
              key={index}
              className="flex flex-col cursor-pointer items-start gap-4 p-6 rounded-2xl shadow-sm
            ...
            hover:shadow-[3px_-1px_6px_1px_rgba(88,255,41,0.35),-1px_2px_3px_0px_rgba(88,255,41,0.1)]"
            >
